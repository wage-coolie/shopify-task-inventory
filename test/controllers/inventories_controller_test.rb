...
class InventoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post inventories_url, params: { inventory: { product_name: @inventory.product_name, quantity: @inventory.quantity } }
    end
  ...
  test "should update inventory" do
    patch inventory_url(@inventory), params: { inventory: { product_name: @inventory.product_name, quantity: @inventory.quantity } }
